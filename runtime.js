...
var imports = {
    ...
    'jsx-board': hasDOM ? {
        ...
        'add-hook!':                 ((board, hook, m, context) => board.addHook(from_fasl(hook), from_fasl(m), from_fasl(context))),
        ...
        'add-touch-event-handlers!': (board => board.addTouchEventHandlers()),
        ...
        'add-child!':                ((board, child) => { board.addChild(child); }),
        ...
        'has-point!':                ((board, x, y) => boolean_to_i32(board.hasPoint(from_fasl(x), from_fasl(y)))),
        ...
        'create-roulette!':          ((board, c1, c2, startC1, stepsize, direction, time, pointlist) =>
                                      board.createRoulette(from_fasl(c1), from_fasl(c2), from_fasl(startC1), from_fasl(stepsize), from_fasl(direction), from_fasl(time), from_fasl(pointlist))),
        ...
        'move-object!':              ((board, x, y, o, evt, type) => { board.moveObject(from_fasl(x), from_fasl(y), o, from_fasl(evt), from_fasl(type)); }),
        'move-origin!':              ((board, x, y, diff) => { board.moveOrigin(from_fasl(x), from_fasl(y), from_fasl(diff)); }),
        'finalize-adding!':          ((board, obj) => { board.finalizeAdding(obj); }),
        ...
        'resize-container!':         ((board, canvasWidth, canvasHeight, dontset, dontSetBoundingBox) => { board.resizeContainer(from_fasl(canvasWidth), from_fasl(canvasHeight), from_fasl(dontset), from_fasl(dontSetBoundingBox)); }),
        ...
        'generate-name':             ((board, object) => board.generateName(object)),
        ...
        'update-infobox!':           ((board, el) => { board.updateInfobox(el); }),
        'set-id!':                   ((board, obj, type) => board.setId(obj, from_fasl(type))),
