...
(define (node-runtime out.wasm #:console-bridge? [console-bridge? #f])
...
(define (browser-runtime out.wasm #:console-bridge? [console-bridge? #f])
  @~a{<!DOCTYPE html>
     <html>
...
(define (runtime #:out  [out.wasm "out.wasm"]
  ...
  (case host
    [(node)    (node-runtime    out.wasm #:console-bridge? console-bridge?)]
    [(browser) (browser-runtime out.wasm #:console-bridge? console-bridge?)]
