  ...
  `(div (@ (class "page"))
        ...
        (section (@ (class "install-hero"))
                 (div (@ (class "install-hero-panel"))
                      (div (@ (class "pill-row"))
                           (span (@ (class "pill")) "wasm-tools + Node")
                           (span (@ (class "pill")) "Racket 9+"))
                      (h1 (@ (class "hero-title")) "Installation")
                      (p (@ (class "hero-lead")) "Set up WebRacket for terminal and browser workflows.")
                      (p (@ (class "install-hero-note"))
                         "The WebRacket compiler depends on two external programs: "
                         (code "wasm-tools")
                         " and "
                         (code "node")
                         ".")))
        ,(section-block
          ...
          (list
           `(div (@ (class "install-grid"))
                 ...
                 (div (@ (class "install-grid-item"))
                      (span (@ (class "install-grid-icon")) "✓")
                      (span (@ (class "install-grid-text")) "A clone of the webracket repo"))))
          #f
          "install-section")
        ,(section-block
          "Installation Steps"
          ...
          (list
           `(div (@ (class "install-steps"))
                 ...
                 (div (@ (class "install-step-card"))
                      (h3 "2. Node.js")
                      (p "Install a recent Node.js release and confirm it runs in your terminal.")
                      (p (a (@ (href "https://nodejs.org/en/download")) "https://nodejs.org/en/download"))
                      (pre (code "node"))
                      (p "Verify that your Node build accepts the required flags.")
                 ...
                 (div (@ (class "install-step-card"))
                      (h3 "3. Racket")
                      (p "Install Racket 9 or newer before running the compiler."))
                 (div (@ (class "install-step-card"))
                 ...
                 (div (@ (class "install-step-card"))
                      ...
                      (p "Grab the source so you can build and run examples.")
                      (pre (code "git clone https://github.com/soegaard/webracket.git")))
                 (div (@ (class "install-step-card"))
                      (h3 "6. Quick test: Run the examples")
                      (p "Serve the examples directory and open the local site.")
                      (pre (code "cd examples\nraco static-web"))
                      (p "Open http://localhost:8000/ and click an html file."))))
          #f
          "install-section")
        ,(footer-section)))
