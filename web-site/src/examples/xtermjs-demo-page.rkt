;;;
;;; Xterm.js demo page (WebRacket site page)
;;;
...
;; This page adapts the original example in:
;;   examples/xtermjs-demo/xtermjs-demo.rkt

;;;
;;; Page Layout
;;;

(define (xtermjs-demo-page)
  `(div (@ (class "page page--xtermjs-demo"))
        ,(navbar)
        ...
        (section (@ (class "section section--examples-details"))
                 (div (@ (class "section-content"))
                      (div (@ (class "examples-details xtermjs-demo-notes"))
                           (div (@ (class "demo-note"))
                           ...
                           (div (@ (class "demo-note demo-note--source"))
                                ...
                                (p (@ (class "demo-note-muted"))
                                   ...
                                   ".")
                                (div (@ (class "examples-actions demo-note-actions"))
...
(define (start-demo . _)
  (unless xtermjs-demo-started?
    (set! xtermjs-demo-started? #t)
        ...
        (unless style-existing
          ...
          (js-set! style "textContent"
                   (string-append
                    ...
                    ".xtermjs-demo .inner.other-theme .hint     { color: rgba(239, 240, 235, 0.7);  }\n"
                    ".xtermjs-demo .inner.other-theme .title    { color: #eff0eb;                   }\n"
                    ".xtermjs-demo .inner.other-theme .subtitle { color: rgba(239, 240, 235, 0.75); }\n"
                    ".xtermjs-demo .xterm { border-radius: 12px; overflow: hidden;"
                    "   box-shadow: 0 12px 36px rgba(0, 0, 0, 0.45); }\n"
                    ".xtermjs-demo .link-hint-decoration {"
        ...
        (js-set-attribute! root "class" "xtermjs-demo")
        ...
        (js-append-child! container root)
...
(define (ensure-xtermjs-demo-assets!)
  (define head (js-document-head))
  ...
  (define script-id "xtermjs-demo-xterm-js")
  (define script-existing (js-get-element-by-id script-id))
  (define webgl-script-id "xtermjs-demo-webgl-addon-js")
  (define webgl-script-existing (js-get-element-by-id webgl-script-id))
  ...
  (cond
    ...
    [else
     ...
     (js-set-attribute! script "src" xtermjs-url)
  ...
  (cond
    ...
    [else
     (define script (js-create-element "script"))
     (js-set-attribute! script "id" webgl-script-id)
     (js-set-attribute! script "src" webgl-addon-url)
     (js-add-event-listener! script "load" maybe-init-external)
     (js-append-child! head script)])

  (maybe-init-demo))

(define (init-xtermjs-demo-page!)
  (js-set! (js-var "document") "title" "Xterm.js Demo")
  (ensure-xtermjs-demo-assets!))
