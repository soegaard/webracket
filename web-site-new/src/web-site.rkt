...
.section--quick-start-next .card-grid--quick-start {
...
.section--installation-steps .card-grid--quick-start {
  grid-template-columns: repeat(1, minmax(0, 1fr));
}
...
.page--space-invaders .arcade-frame {
  padding: 8px 0 0;
}
.page--space-invaders .arcade-bezel {
  padding: 0;
  border: 0;
  border-radius: 12px;
  background: transparent;
...
.page--space-invaders .arcade-bezel::after {
  display: none;
}
.page--space-invaders .arcade-bezel canvas {
  border-radius: 10px;
  border: 0;
  box-shadow: 0 8px 20px rgba(20, 32, 52, 0.14);
}
