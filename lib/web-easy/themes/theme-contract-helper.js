(function () {
  ...
  function ensureThemeLayer(frameDoc, options) {
    ...
    const coreHref = options && options.coreHref ? options.coreHref : "../themes/web-easy-core.css";
    const themeHref = options && options.themeHref ? options.themeHref : "../themes/theme-contract-vars.css";

    if (!frameDoc || !frameDoc.documentElement || !frameDoc.head) {
      return false;
    }
