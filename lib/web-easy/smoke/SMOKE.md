...
- current allowlist for this check: layout/container widgets that still use backend layout inline style (`vpanel`, `hpanel`, `group`, `if-view`, `cond-view`, `case-view`, `observable-view`, `list-view`, `tab-list`).
