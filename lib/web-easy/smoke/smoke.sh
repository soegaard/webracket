...
print_parity_urls() {
  ...
  echo "  $base_url/test-browser-parity-offcanvas.html"
  echo "  $base_url/test-browser-parity-offcanvas-contract.html"
  echo "  $base_url/test-browser-parity-close-button.html"
  echo "  $base_url/test-browser-parity-close-button-contract.html"
  echo "  $base_url/test-browser-parity-placeholder.html"
  echo "  $base_url/test-browser-parity-placeholder-contract.html"
  echo "  $base_url/test-browser-parity-carousel.html"
  echo "  $base_url/test-browser-parity-carousel-contract.html"
  echo "  $base_url/test-browser-parity-scrollspy.html"
  echo "  $base_url/test-browser-parity-scrollspy-docs.html"
  echo "  $base_url/test-browser-parity-scrollspy-contract.html"
