...
(async () => {
  ...
  await pageB.waitForSelector('.showcase-main .we-navigation-bar', { timeout: 30000 });
  await pageB.waitForFunction(() => {
    const html = document.documentElement;
    const nav = document.querySelector('.showcase-main .we-navigation-bar');
  ...
  const b = await collectComputed(pageB, `() => {
    const nav = document.querySelector('.showcase-main .we-variant-${variant} .we-navigation-bar')
             || document.querySelector('.showcase-main .we-navigation-bar.we-variant-${variant}')
             || document.querySelector('.showcase-main .we-navigation-bar');
  ...
  const bText = await pageB.evaluate((variantName) => {
    const nav = document.querySelector('.showcase-main .we-variant-' + variantName + ' .we-navigation-bar')
             || document.querySelector('.showcase-main .we-navigation-bar.we-variant-' + variantName)
             || document.querySelector('.showcase-main .we-navigation-bar');
    const dropdown = nav ? nav.querySelector('[data-we-widget="menu"]') : null;
