...

{
  ...
  echo -e "make\tmake smoke-ci-full\tCompatibility alias for make smoke-ci."
  ...
  echo -e "make\tmake smoke-contract\tCompatibility alias for ./headless.sh contract."
  echo -e "make\tmake smoke-compat\tShow compatibility aliases and preferred replacements."
