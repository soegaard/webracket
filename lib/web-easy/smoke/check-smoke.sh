...
labels=(
  ...
  "visual-check"
  "parity-all capsules (hello/counter/dynamic-list/counters/tabs/tabs-disabled/tabs-dynamic/profile/settings/progress/table/theme-vars/theme-dialog-vars/theme-menu-vars/menu-keys/menu-full/dropdown/tooltip/popover/dialog/list/todo/incident/release/workspace)"
)
