...
labels=(
  ...
  "visual-check"
  "parity-all capsules (hello/counter/dynamic-list/counters/button-group/button-toolbar/card/alert/badge/spinner/pagination/list-group/toast/collapse/tabs/tabs-disabled/tabs-dynamic/profile/settings/progress/table/theme-vars/theme-dialog-vars/theme-menu-vars/menu-keys/menu-full/dropdown/navigation-bar/tooltip/popover/dialog/list/todo/incident/release/workspace)"
)
