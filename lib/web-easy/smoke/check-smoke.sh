...
labels=(
  "smoke-all capsules (smoke/input/checkbox/list/branch/destroy/controls/width/theme-vars/theme-dialog-vars/theme-menu-vars/theme-token-contract/menu-keys/menu-full/group/alert/collapse/accordion/dialog/operators/tab-panel/tab-panel-disabled/tab-panel-dynamic)"
  "visual-check"
