...
(define tooltip-header-node (node-child tooltip-bubble-node 0))
(define tooltip-body-node (node-child tooltip-bubble-node 1))
(define tooltip-footer-node (node-child tooltip-bubble-node 2))
