...
(define (gallery-3d-view-options)
  (jsx-attributes
   [projection "parallel"]
   [axes-position "none"]
   [x-plane-rear (jsx-attributes
                  [fill-color "#fff"]
                  [mesh3d (jsx-attributes [visible #f])])]
   [y-plane-rear (jsx-attributes
                  [fill-color "#fff"]
                  [mesh3d (jsx-attributes [visible #f])])]
   [z-plane-rear (jsx-attributes
                  [fill-color "#fff"]
                  [mesh3d (jsx-attributes [visible #f])])]
   [x-plane-front (jsx-attributes
                   [visible #t]
                   [fill-color "#fff"]
                   [mesh3d (jsx-attributes [visible #f])])]
   [y-plane-front (jsx-attributes
                   [visible #t]
                   [fill-color "#fff"]
                   [mesh3d (jsx-attributes [visible #f])])]
   [z-plane-front (jsx-attributes
                   [visible #t]
                   [fill-color "#fff"]
                   [mesh3d (jsx-attributes [visible #f])])]
   [x-plane-rear-y-axis (jsx-attributes [visible #f])]
   [x-plane-rear-z-axis (jsx-attributes [visible #f])]
   [y-plane-rear-x-axis (jsx-attributes [visible #f])]
   [y-plane-rear-z-axis (jsx-attributes [visible #f])]
   [z-plane-rear-x-axis (jsx-attributes [visible #f])]
   [z-plane-rear-y-axis (jsx-attributes [visible #f])]
   [x-plane-front-y-axis (jsx-attributes [visible #f])]
   [x-plane-front-z-axis (jsx-attributes [visible #f])]
   [y-plane-front-x-axis (jsx-attributes [visible #f])]
   [y-plane-front-z-axis (jsx-attributes [visible #f])]
   [z-plane-front-x-axis (jsx-attributes [visible #f])]
   [z-plane-front-y-axis (jsx-attributes [visible #f])]))
...
(define (grid-style-attributes mode)
  (cond
    ...
    [(string=? mode "fancy")
     (jsx-attributes
      [major (jsx-attributes
              [face "plus"]
              [size 7]
              [stroke-color "green"]
              [stroke-opacity 1])]
      [minor (jsx-attributes
              [size 4])]
      [minor-elements 3])]
    [else
     (jsx-attributes
        ...
        (unless tangentto-board-ready?
          ...
          (set! tangentto-left
                (jsx-create-tangentto
                 ...
                 (jsx-attributes
                  [color "black"]
                  [polar (jsx-attributes [visible #t])]
                  [point (jsx-attributes [visible #t])])))
          (set! tangentto-right
                (jsx-create-tangentto
                 tangentto-board
          ...
          (set! legend-chart
                (jsx-create-chart
                 ...
                 (jsx-attributes
                  [chart-style "bar"]
                  [labels #(4 2 3 1)]
                  [colors (jsx-parents "red" "green" "blue" "orange")])))
          (set! legend-object
                (jsx-create-legend
                 legend-board
                 (jsx-parents 2 3)
        ...
        (unless parallel-board-ready?
          ...
          (set! parallel-line
                (jsx-create-line parallel-board
                                 ...
                                 (jsx-attributes [stroke-color "#2b6cb0"])))
          (set! parallel-object
          ...
          (set! line3d-line
                (jsx-view3d-create-line3d
                 ...
                 (jsx-attributes
                  [stroke-color "#2b6cb0"]
                  [stroke-width 3]
                  [point1 (jsx-attributes [visible #t])]
                  [point2 (jsx-attributes [visible #t])])))
                ...
                (jsx-view3d-create-polyhedron3d
                 ...
                 (jsx-parents
                  ...
                  (vector (vector 0 1 2 3)
                          ...
                          (vector 3 0 4 7)))
                 (jsx-attributes
                  [fill-color-array (vector "#2b6cb0" "#c53030" "#38a169" "#d69e2e")]
                  [fill-opacity 0.7]
                  [stroke-color "#2d3748"]
                  [stroke-width 1])))
