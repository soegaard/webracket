...
(require "aim.rkt"
         ...
         "struct-convert.rkt"
         "literal.rkt"
         "unnest-let.rkt"      ; remove?
         "left-to-right.rkt"   ; todo remove
         "letrec.rkt"
         "authentic.rkt"
         "single-valued.rkt"
         "equal.rkt"
...
;; Convert a linklet into a WebRacket lambda

;; (define (schemify-linklet
;;          lk serializable?-box datum-intern? target allow-set!-undefined?
...
;    (webified importss exports import-keys imports-abis exports-info)
; 

(define (webify-linklet lk
     ...
     (define imports
       ...
       (define add-import!
         (make-add-import! imports
                           ...
                           get-import-knowns
                           (lambda (new-grp)
                             (set! new-grps (cons new-grp new-grps)))))
       ...
       (define exports
         (for/fold ([exports (hasheq)]) ([ex-id (in-list ex-ids)])
           ...
           (hash-set exports id
                     (export (deterministic-gensym id) (ex-ext-id ex-id)))))
       ...
       (define-values (new-body defn-info mutated)
         (webify-body* bodys prim-knowns primitives imports exports
                       serializable?-box datum-intern? allow-set!-undefined?
                       add-import! target
       ...
       (values
        ;; Build `lambda` with webified body:
...
(define (webify-body l prim-knowns primitives imports exports
                       target unsafe-mode? no-prompt? explicit-unnamed?)
  (with-deterministic-gensym
    (define-values (new-body defn-info mutated)
      (webify-body* l prim-knowns primitives imports exports
...
(define (webify-body*
         l prim-knowns primitives imports exports
         serializable?-box datum-intern? allow-set!-undefined? add-import!
         target unsafe-mode? enforce-constant? allow-inline? no-prompt?
         explicit-unnamed?
         compiler-query)
  ...
  (define mutated (mutated-in-body l exports extra-variables prim-knowns
                                   (hasheq) imports simples
...
(define (webify v prim-knowns primitives knowns mutated imports exports extra-variables simples allow-set!-undefined? add-import!
