;; Additional flonum tests focused on arithmetic operations and
;; extended behaviors derived from Racket's
;; collects/tests/racket/flonum.rktl. Exception-raising cases are
;; omitted because webracket lacks exception support.
