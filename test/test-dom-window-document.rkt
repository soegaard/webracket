...
(list "Document and element wrappers"
      (let ()
         ...
         (check-true (vector? host-children) "element children vector")
         (check-equal (vector-length host-children) 1 "element children count")
         (check-true (element? (vector-ref host-children 0)) "element children item")
