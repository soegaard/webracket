...
(list "Document and element wrappers"
      (let ()
         ...
         (define span-list (element-query-selector-all host 'span))
         (check-true (vector? span-list) "element query selector all vector")
         (check-equal (vector-length span-list) 1 "element query selector all")
         (check-true (element? (vector-ref span-list 0)) "element query selector all item")
         ...
         (check-true (vector? (element-get-elements-by-class-name host 'sprout))
                     "element class-name descendants vector")
         (check-true (vector? (element-get-elements-by-tag-name host 'span))
                     "element tag-name descendants vector")
