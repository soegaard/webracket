...
(list "Document and element wrappers"
      (let ()
         ...
         (check-true (dom-element? (element-previous-element-sibling (dom-test-fixture "host")))
                     "element previous sibling wrapper")
         ...
         (check-true (dom-element? (node-list-item span-list 0)) "document query selector all item")
         ...
         (check-true (dom-element? (node-list-item element-span-list 0)) "element query selector all item")
         ...
         (check-true (dom-element? (html-collection-item class-descendants 0))
         ...
         (check-true (dom-node? (document-create-cdata-section 'hello))
         ...
         (check-true (dom-attr? (element-get-attribute-node host 'data-state))
