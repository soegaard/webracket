...
(list "Document and element wrappers"
      (let ()
         ...
         (check-true (text-node? leaf) "document create-text-node wrapper")
         (check-true (external? (text-node-raw leaf)) "document create-text-node raw")
         ...
         (check-true (element? (element-parent-element (dom-test-fixture "host")))
                     "element parent wrapper")
         (check-true (element? (element-previous-element-sibling (dom-test-fixture "host")))
                     "element previous sibling wrapper")
         (check-true (element? (element-next-element-sibling (dom-test-fixture "host")))
         ...
         (when doc-selection
           (check-true (selection? doc-selection) "document selection wrapper")
