...
(list "Document and element wrappers"
      (let ()
         ...
         (check-false (element-toggle-attribute! host 'data-flag (lambda () #f)) "element toggle off")
         (element-replace-children! host (document-create-text-node 'updated))
         (check-equal (element-text-content host) "updated" "element replace-children")
